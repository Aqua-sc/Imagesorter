...
<div class="flex p-3 gap-4 px-2">
	...
	{#if file}
		<div class="w-selected-text">
			<button class="bg-red-500 mr-2 mb-2 px-3 py-2 rounded text-white disabled:text-gray-300 hover:bg-red-700 flex items-center justify-center gap-2 mt-2" title = "Remove picture" on:click={removeselected}>
